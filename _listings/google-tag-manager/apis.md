...
- name: Google Tag Manager API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/container/master/_listings/google-tag-manager/accounts-accountid-containers-containerid-versions-post.md
x-common:
